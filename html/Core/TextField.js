...
newui.TextField = cc.Node.extend({
    ...
    setText : function (text) {
        if(cc.isString(text)){
            ...
            cc.log("TextField::SetText param is not String: ", text);
        }
    },
    ...
    setPlaceHolderColor : function(color) {
        ...
        if(this.placeHolderLabel.setOpacity){
            this.placeHolderLabel.setOpacity(color.a !== undefined ? color.a : 255);
        }
    },

    setTextColor : function(color) {
        this.textLabel.setColor(color);
        if(this.textLabel.setOpacity){
            this.textLabel.setOpacity(color.a !== undefined ? color.a : 255);
        }

        this.textCursor.setColor(color);
        if(this.textCursor.setOpacity){
            this.textCursor.setOpacity(color.a !== undefined ? color.a : 255);
        }
    },
