...
var BaCay = IGameScene.extend({
    ...
    initScene: function () {
        ...
        var huThuongLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_UTMAvoBold_24, "HŨ BA CÂY : ");
        ...
        var huThuongValueLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_UTMAvoBold_24, "");
...
/*
    ...
    initPlayer: function () {
        ...
        for (var i = 1; i < this.playerView.length; i++) {
            ...
            var resultLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_UTMAvoBold_24, "", cc.TEXT_ALIGNMENT_LEFT);
