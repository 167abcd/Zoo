...
var TaiXiuBettingSlot = cc.Node.extend({
    ctor: function (idx, parentNode) {
        ...
        var bg = new ccui.Scale9Sprite("taixiu_winSprite.png", cc.rect(40,40,4,4));
        ...
        var slotGoldLabel = new cc.LabelBMFont("100", cc.res.font.Roboto_Medium_20);
        slotGoldLabel.setColor(cc.color("#d9d9d9"));
        ...
        var userGoldLabel = new cc.LabelBMFont("100", cc.res.font.Roboto_Medium_20);
...
var TaiXiuScene = XocDiaScene.extend({
    ...
    initBettingSlot: function () {
        ...
        var timeLabel = new cc.LabelTTF("99", cc.res.font.Roboto_Medium, 30 * cc.winSize.screenScale);
    ...
    initHistory: function () {
        ...
        var historyBg = new ccui.Scale9Sprite("taixiu_history_bg1.png", cc.rect(4, 4, 4, 4));
        ...
        for (var i = 0; i < col; i++) {
            ...
            var bg = new ccui.Scale9Sprite("taixiu_history_bg2.png", cc.rect(4, 4, 4, 4));
    ...
    _refreshHistory: function () {
        ...
        for (var i = 0; i < this._historyData.length; i++) {
            ...
            if (sum > 10) {
                var label = new cc.LabelBMFont("TÀI", cc.res.font.Roboto_Medium_20);
                label.setColor(cc.color("#d9d9d9"));
            }
            else {
                var label = new cc.LabelBMFont("XỈU", cc.res.font.Roboto_Medium_20);
                label.setColor(cc.color("#ffde00"));
            }
            label.setPosition(x, 16.0);
            this.historyNode.addChild(label, 1);

            var sumLabel = new cc.LabelBMFont(sum.toString(), cc.res.font.Roboto_Medium_20);
            sumLabel.setScale(16 / 20);
            sumLabel.setColor(cc.color("#d9d9d9"));
