...
var ListChiMB = cc.Node.extend({
    ...
    setNameChi:function (chi, name, isWin) {
        ...
        var nameChi = 0;
        if(isWin){
            nameChi = cc.Label.createWithBMFont("res/Texture/GameBai/fnt/Font_MauBinh_SoChi.fnt", name);

        }else{
            nameChi = cc.Label.createWithBMFont("res/Texture/GameBai/fnt/Font_MauBinh_SoChi2.fnt", name);
        }

        cc.log("da vao day => " + name);
...
var MauBinhCardList = cc.Node.extend({
    ...
    showResultChi: function (index, nameChi, duration) {
        ...
        var resultLabel = new cc.LabelBMFont(nameChi, "res/Texture/GameBai/fnt/Font_MauBinh_SoChi.fnt");
        resultLabel.setScale(0.7);
        resultLabel.setAnchorPoint(1,0.5);
        resultLabel.setPosition(this.displayResultRight ? 500 : -300, (index - 1) * 125);
    ...
    performSwapCardInPoint: function (card, touchPoint) {
        ...
        SceneNavigator.getRunningScene().OnSwapPhom();
...
var MauBinh = IGameScene.extend({
    ...
    initScene: function () {
        ...
        huThuongBg.setAnchorPoint(cc.p(1.0, 0.5));
        huThuongBg.setPosition(cc.winSize.width - 20, 60);
        this.addChild(huThuongBg);

        var huThuongLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Medium_25, "Hũ mậu binh: ");
        huThuongLabel.setAnchorPoint(cc.p(0.0, 0.5));
        huThuongLabel.setPosition(16, huThuongBg.height/2);
        huThuongBg.addChild(huThuongLabel);

        var huThuongValueLabel = cc.Label.createWithBMFont(cc.res.font.Roboto_Medium_25, "0");
        huThuongValueLabel.setAnchorPoint(cc.p(0.0, 0.5));
        huThuongValueLabel.setPosition(229, huThuongLabel.y);
        huThuongValueLabel.setColor(cc.color("#ffcb2c"));
    ...
    initLayerArrangement:function () {
        ...
        var listCardMe = new MauBinhCardList(cc.p(640, 330));
        ...
        timeOutMe.setScale(0.7);
        timeOutMe.setPosition(797, 510)
    ...
    initPlayer: function () {
        ...
        playerMe.setPosition(67, 58.0);
        playerMe.cardList = new ListChiMB(cc.p(cc.winSize.width/2 - 67, 140));
        playerMe.setPositionInfo(PL_POSITION_LEFT);

        playerMe.cardList.setScale(0.8);
        playerMe.infoLayer.addChild(playerMe.cardList, 2);
        this.table_bg.addChild(playerMe, 1);

        var player1 = new GamePlayer();
        player1.setPosition(1195, 412);
        player1.cardList = new ListChiMB(cc.p(-210, -40));
        ...
        player1.cardList.setScale(0.75);
        player1.infoLayer.addChild(player1.cardList, 2);
        this.table_bg.addChild(player1, 1);

        var player2 = new GamePlayer();
        player2.setPosition(850, 636);
        player2.cardList = new ListChiMB(cc.p(-210, -60));
        ...
        player3.cardList = new ListChiMB(cc.p(210, -40));
        player3.cardList.setScale(0.75);
        ...
        for(var i=1;i<this.playerView.length;i++){
            this.playerView[i].x = cc.winSize.width/2 + (this.playerView[i].x - 640) * cc.winSize.screenScale;
            this.playerView[i].y = cc.winSize.height/2 + (this.playerView[i].y - 360) * cc.winSize.screenScale;
            this.playerView[i].setScale(cc.winSize.screenScale);
        }
    },
    ...
    initButton: function () {
        ...
        startBt.setPosition(cc.winSize.width - 366 * cc.winSize.screenScale, 150);
        ...
        xepLaiBt.setPosition(cc.p(startBt.getPositionX(), startBt.getPositionY()));
        ...
        // this.arrangeLayer.setVisible(true);
    },
    ...
    showJackpot: function (nameNo,money) {
        ...
        var textNo = "Chúc mừng " + name + " nổ hũ: " + cc.Global.NumberFormat1(parseInt(money));
    ...
    performShowResult: function (delay) {
        ...
        setTimeout(function () {
            ...
            for (var i = 0; i < thiz.resultEntries.length; i++) {
                ...
                dialog.setGold(i, thiz.resultEntries[i].moneyChange);
                var string1 = "";
