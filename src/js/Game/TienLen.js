...
var CardRemaining = cc.Node.extend({
    ctor: function () {
        ...
        var label = new cc.LabelBMFont("99", cc.res.font.Roboto_UTMAvoBold_24);
...
var TienLen = IGameScene.extend({
    ctor: function () {
        ...
        //initCardxd
        var cardList = new CardList(cc.size(1400, 126));
        cardList.deckPoint =  cc.p(700, 350);
        cardList.setAnchorPoint(cc.p(0.5, 0.0));
        cardList.setPosition(1000, 112.0);
        ...
        cardOnTable.cardPosition = cc.p(1000, 400);
        ...
        //     cardArr.push(card);
        // }
        // thiz.setCardList(cardList,cardArr);
        // setTimeout(function () {
        //     thiz.allSlot[0].username = "Player";
        //     thiz.onDanhbaiMe("Player", cardArr);
        // }, 1000);

        //danh bai
        // setTimeout(function () {
        //     thiz.allSlot[1].username = "Player";
        //     thiz.onDanhbaiOther("Player", cardArr);
        // }, 1000);
    },
    ...
    initPlayer: function () {
        ...
        playerMe.setPosition(417, 58.0);
        this.sceneLayer.addChild(playerMe, 1);

        var player1 = new GamePlayer();
        player1.setPosition(1562, 426);
    ...
    onDanhbaiOther: function (username, cards) {
        var slot = this.getSlotByUsername(username);
        this.cardOnTable.moveOldCard();
        var p = slot.getParent().convertToWorldSpace(slot.getPosition());
        this.cardOnTable.addNewCardList(cards, p);
        this.suggestGroups = TLMNUtility.getSuggestedCards(cards, this.cardList.cardList);
        this.isNewTurn = false;
        SoundPlayer.playSound("danh_bai");
    },
