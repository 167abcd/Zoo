...
var Sam = TienLen.extend({
    ...
    initButton : function () {
        ...
        huysamBt.setPosition(1285, 63);
        this.sceneLayer.addChild(huysamBt);
        this.huysamBt = huysamBt;

        var timeLabel = cc.Label.createWithBMFont("res/Texture/GameBai/fnt/fnt_sam_font_1.fnt", "9");
        timeLabel.setPosition(1000, 400);
    ...
    initPlayer: function () {
        ...
        for (var i = 1; i < this.playerView.length; i++) {
            ...
            oneCardNotify.setPosition(this.playerView[i].avt.getPosition());
           ...
           // this.playerView[i].cardRemaining.setVisible(false);
            ...
            oneNotifyBaoSam.setPosition(this.playerView[i].avt.getPosition());
