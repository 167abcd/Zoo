...
var JackpotLayer = cc.Node.extend({
    ctor : function () {
        ...
        // var lblText = new cc.LabelTTF("10000",cc.res.font.Roboto_CondensedBold,45);
        // lblText.setColor(cc.color(255,245,91,255));
        // lblText.setPosition(cc.winSize.width/2, 500);
        ...
        var shakeAction = new ext.ActionShake2D(1, cc.p(10, 0));
        var frames = [];
