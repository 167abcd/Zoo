...
socket.LobbyClient.prototype._ctor = function (socketType, pingTime) {
    this.initClientWithType(socketType);
    return true;
};

socket.LobbyClient.prototype.closeLostPing = function () {
    this.lostPing();
};
...
socket.SmartfoxClient.ClientDisconnectionReason = {};
socket.SmartfoxClient.ClientDisconnectionReason.IDLE = 0;
socket.SmartfoxClient.ClientDisconnectionReason.KICK = 1;
socket.SmartfoxClient.ClientDisconnectionReason.BAN = 2;